...
ENTRYPOINT ["java","-noverify","-jar","app/lib/app.jar","HOSTS=$HOSTS","NETWORK=$NETWORK","BULK_SIZE=$BULK_SIZE","STARCOIN_ES_URL=$STARCOIN_ES_URL","STARCOIN_ES_PROTOCOL=$STARCOIN_ES_PROTOCOL","STARCOIN_ES_PORT=$STARCOIN_ES_PORT","STARCOIN_ES_USER=$STARCOIN_ES_USER","STARCOIN_ES_PWD=$STARCOIN_ES_PWD"]